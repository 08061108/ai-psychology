  ...
  <div class="auth-layout">
    <div class="left-section">
      <div class="content">
        ...
        <div class="robot">
          <el-image :src="iconURL" alt="robot" />
        </div>
      </div>
    </div>
...
const iconURL =new URL('@/assets/images/robot-fill.png', import.meta.url).href // 先将图标图片路径转换为绝对路径 new URL() 构造函数返回的是一个 URL 对象 ，不是字符串 ，需要使用 href 属性获取绝对路径
</script>
